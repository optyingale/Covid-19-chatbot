    ...
    def india_or_worldwide(self, df):
        try:
            if df.index.name == 'state':
                ...
                plt.title('Covid-19 Statewise Data — Deaths', fontdict={'fontsize': '25', 'fontweight': '3'})
                ...
                plt.title('Covid-19 Statewise Data — Active Cases', fontdict={'fontsize': '25', 'fontweight': '3'})
                ...
                plt.title('Covid-19 Statewise Data — Confirmed Cases', fontdict={'fontsize': '25', 'fontweight': '3'})
                ...
                plt.title('Covid-19 Statewise Data — Recovered Cases', fontdict={'fontsize': '25', 'fontweight': '3'})
                ...
                plt.title('Covid-19 World — TotalDeaths', fontdict={'fontsize': '30', 'fontweight': '15'})
                plt.savefig('Deceased.png')
                ...
                plt.title('Covid-19 World — ActiveCases', fontdict={'fontsize': '30', 'fontweight': '15'})
                plt.savefig('Active.png')
                ...
                plt.title('Covid-19 World — TotalCases', fontdict={'fontsize': '30', 'fontweight': '15'})
                plt.savefig('Confirmed.png')
                ...
                plt.title('Covid-19 World — TotalRecovered', fontdict={'fontsize': '30', 'fontweight': '15'})
                plt.savefig('Recovered.png')
